...
description: How CKP v3.7 provisions OIDC identity as infrastructure through the AuthConfig ontology class, deploy.auth reconciliation step, Keycloak realm management, three-level authentication model, SPIFFE JWT-SVID integration, and anonymous-to-authenticated escalation.
---
