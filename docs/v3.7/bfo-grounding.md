...
|--------|----------|----------|---------------------|-----------|
| TBox | CK Loop | `conceptkernel.yaml`, `ontology.yaml` (LinkML source), `cktype/models.py` (generated Pydantic), `cktype/rdf.ttl` (generated triples), `rules.shacl` (generated SHACL) | Volume `ck-{guid}-ck`, ReadOnly | Rigorous |
