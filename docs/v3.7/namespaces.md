...
description: The 13 namespace prefixes and URIs used throughout CKP v3.7.
---

# Namespace Declarations

All namespace prefixes used in the CKP v3.7 specification are declared below. Conformant implementations MUST use these prefixes when emitting RDF, Turtle, or SPARQL.

## Namespace Prefix Table

| Prefix | Namespace URI | Description |
|--------|--------------|-------------|
| `ckp:` | `https://conceptkernel.org/ontology/v3.7/` | CKP Protocol (Layer 1) |
| `ckpp:` | `https://conceptkernel.org/ontology/v3.7/process#` | CKP Process sub-ontology |
| `ckpr:` | `https://conceptkernel.org/ontology/v3.7/relations#` | CKP Relations sub-ontology |
| `ckpw:` | `https://conceptkernel.org/ontology/v3.7/workflow#` | CKP Workflow sub-ontology |
| `ckpi:` | `https://conceptkernel.org/ontology/v3.7/improvement#` | CKP Self-Improvement sub-ontology |
...
@prefix ckpr: <https://conceptkernel.org/ontology/v3.7/relations#> .
...
::: tip
The `ckp:` prefix URI includes the version (`v3.7/`). When a new major version of the protocol is released, the prefix URI will change accordingly. Implementations SHOULD NOT hard-code the version segment -- use the prefix declared in the kernel's `ontology.yaml`.
:::
